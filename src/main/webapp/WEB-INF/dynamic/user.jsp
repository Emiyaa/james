                                ...
                                <form action="${pageContext.request.contextPath }/update.do" method="post">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder=""
                                                       value="${user.usernickname}" name="usernickname">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>用户名</label>
                                                <input type="text" class="form-control" disabled placeholder="用户名"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control" disabled placeholder="Email"
                                                       value="${user.usermail}" name="usermail">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>生日</label>
                                                <input type="text" class="form-control" placeholder="生日" name="userbirthday"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>手机</label>
                                                <input type="mobile" class="form-control" placeholder="Phone"
                                                       value="${user.usermobile}" name="usermobile">
                                            </div>
                                        </div>
                                    </div>
